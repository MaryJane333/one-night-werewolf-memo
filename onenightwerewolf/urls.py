...
from .views import Delete, google_func, list_func, login_func, logoutfunc, NameCreate,NameUpdate, NumberCreate, NumberUpdate, sign_up_func
...
urlpatterns = [
    ...
    path('google/', google_func, name='google'),
